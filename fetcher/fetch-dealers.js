...
const MAKES = [
  ...
  { id: "gmc",           label: "GMC",           color: "#cc0000" },
  { id: "mazda",         label: "Mazda",         color: "#910000" },
  { id: "volkswagen",    label: "Volkswagen",    color: "#001e50" },
  { id: "bmw",           label: "BMW",           color: "#0066b1" },
  { id: "mercedes",      label: "Mercedes-Benz", color: "#222222" },
  { id: "audi",          label: "Audi",          color: "#bb0a14" },
  { id: "lexus",         label: "Lexus",         color: "#1a1a1a" },
  { id: "acura",         label: "Acura",         color: "#cc0000" },
  { id: "infiniti",      label: "Infiniti",      color: "#1a1a1a" },
  { id: "dodge",         label: "Dodge",         color: "#cc2200" },
  { id: "buick",         label: "Buick",         color: "#205493" },
  { id: "cadillac",      label: "Cadillac",      color: "#284f8c" },
  { id: "lincoln",       label: "Lincoln",       color: "#2d2d2d" },
...
function isRelevantDealer(place, make) {
  ...
  const makeKeywords = {
    ...
    acura:         ["acura"],
    infiniti:      ["infiniti"],
    dodge:         ["dodge", "chrysler", "ram"],
    buick:         ["buick", "gmc", "cadillac", "chevrolet"],
    cadillac:      ["cadillac"],
